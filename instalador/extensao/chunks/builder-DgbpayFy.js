const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/elk.bundled-Csj217si.js","chunks/chunk-JhU6G7TY.js"])))=>i.map(i=>d[i]);
import { o as __toESM } from "./chunk-JhU6G7TY.js";
import "./_virtual_wxt-html-plugins-CvbLecxM.js";
import { $ as readonly, A as onMounted, B as useSlots, C as h, D as nextTick, E as mergeProps, F as renderSlot, H as watchEffect, I as resolveComponent, J as getCurrentScope, K as customRef, L as resolveDynamicComponent, M as openBlock, N as provide, O as onBeforeMount, P as renderList, Q as reactive, S as getCurrentInstance, T as isMemoSame, U as withCtx, V as watch, W as withDirectives, X as markRaw, Y as isRef, Z as onScopeDispose, _ as createStaticVNode, a as vModelText, at as unref, c as withModifiers, ct as toDisplayString, d as computed, et as ref, f as createBaseVNode, g as createPropsRestProxy, h as createElementBlock, i as vModelSelect, it as toValue$1, j as onUnmounted, k as onBeforeUnmount, l as Fragment, m as createCommentVNode, n as createApp, nt as toRef, ot as normalizeClass, p as createBlock, q as effectScope, r as vModelCheckbox, rt as toRefs$1, st as normalizeStyle, tt as shallowRef, u as Teleport, v as createTextVNode, w as inject, x as defineComponent, y as createVNode, z as useAttrs } from "./runtime-dom.esm-bundler-D0J2iYbf.js";
...
import { t as useRRV3Rpc } from "./useRRV3Rpc-CLEDiQHV.js";
import { a as getNodeSpec, c as stepsToNodes$1, l as topoOrder$1, o as listNodeSpecs, r as STEP_TYPES, s as registerBuiltinSpecs, t as EDGE_LABELS } from "./dist-DwEL_LJB.js";
import { n as _objectWithoutProperties, t as __vitePreload } from "./preload-helper-C3C4MqOo.js";
...
* @returns 转换结果，包含Sucesso/FalhouEstado、数据eErro/AvisoInformação
*/
...
*
* 规则：
* 1. 排除 trigger TipoNó（这些是 UI Nó，不参与执行）
* 2. 只统计「可执行Nó -> 可执行Nó」的边来计算入度（忽略 trigger 指出的边）
* 3. 找到入度为 0 的Nó作为候选
* 4. 如果有多个候选，使用稳定选择规则：
*    - 优先选择 UI 坐标最靠左上的Nó（按 x 升序，x 相同按 y 升序）
*    - 如果Nenhum UI 坐标，按 ID 字典序取第一个
*/
...
/**
* 将 V3 Flow 转换为 V2 Flow（用于在 V2 Builder 中Editar）
...
/**
* 将 V2 Flow 转换为 V3 格式，用于 RPC Salvar
* @param flowV2 Builder store 中的 V2 Flow
* @returns V3 Flow eAvisoInformação
* @throws 转换Falhou时抛出Erro
*/
...
/**
* 将 V3 Flow 转换为 V2 格式，用于 Builder 显示eEditar
* @param flowV3 从 RPC 获取的 V3 Flow
* @returns V2 Flow eAvisoInformação
* @throws 转换Falhou时抛出Erro
*/
...
/**
* 判断是否为 V3 Flow
* @description 用于Importar时判断 JSON 格式
*/
...
function topoOrder(nodes, edges) {
	return topoOrder$1(nodes, (edges || []).filter((e) => !e.label || e.label === EDGE_LABELS.DEFAULT));
}
...
function summarizeNode(n) {
	...
	if (!n) return "";
	if (n.type === STEP_TYPES.CLICK || n.type === STEP_TYPES.FILL) return ((_n$config = n.config) === null || _n$config === void 0 || (_n$config = _n$config.target) === null || _n$config === void 0 || (_n$config = _n$config.candidates) === null || _n$config === void 0 || (_n$config = _n$config[0]) === null || _n$config === void 0 ? void 0 : _n$config.value) || "未ConfiguraçãoSeletor";
...
function validateNode(n) {
	...
	switch (n.type) {
		...
		case "fill":
			var _c$target;
			if (!!!(c === null || c === void 0 || (_c$target = c.target) === null || _c$target === void 0 || (_c$target = _c$target.candidates) === null || _c$target === void 0 ? void 0 : _c$target.length)) errs.push("Seletor alvo candidato ausente");
			if (n.type === "fill" && (!("value" in c) || c.value === void 0)) errs.push("缺少输入值");
			break;
		case STEP_TYPES.WAIT:
			if (!(c === null || c === void 0 ? void 0 : c.condition)) errs.push("Condição de espera ausente");
			break;
		case STEP_TYPES.ASSERT:
			if (!(c === null || c === void 0 ? void 0 : c.assert)) errs.push("Condição de asserção ausente");
			break;
		case STEP_TYPES.NAVIGATE:
			if (!(c === null || c === void 0 ? void 0 : c.url)) errs.push("URL ausente");
			break;
		case STEP_TYPES.HTTP:
			if (!(c === null || c === void 0 ? void 0 : c.url)) errs.push("HTTP: URL ausente");
			if ((c === null || c === void 0 ? void 0 : c.assign) && typeof c.assign === "object") {
				...
				for (const v of Object.values(c.assign)) {
					const s = String(v);
					if (!pathRe.test(s)) errs.push(`Assign: caminho inválido ${s}`);
				}
			}
			break;
		case STEP_TYPES.HANDLE_DOWNLOAD: break;
		case STEP_TYPES.EXTRACT:
			if (!(c === null || c === void 0 ? void 0 : c.saveAs)) errs.push("Extract: 需填写SalvarNome da variável");
		...
		case STEP_TYPES.TRIGGER_EVENT:
			var _c$target2;
			if (!!!(c === null || c === void 0 || (_c$target2 = c.target) === null || _c$target2 === void 0 || (_c$target2 = _c$target2.candidates) === null || _c$target2 === void 0 ? void 0 : _c$target2.length)) errs.push("Seletor alvo candidato ausente");
			if (!String((c === null || c === void 0 ? void 0 : c.event) || "").trim()) errs.push("需提供事件Tipo");
			break;
		case STEP_TYPES.IF: {
			const arr = Array.isArray(c === null || c === void 0 ? void 0 : c.branches) ? c.branches : [];
			if (arr.length === 0) errs.push("需Adicionar至少一个Condição分支");
			for (let i = 0; i < arr.length; i++) {
				var _arr$i;
				if (!String(((_arr$i = arr[i]) === null || _arr$i === void 0 ? void 0 : _arr$i.expr) || "").trim()) errs.push(`分支${i + 1}: 需填写Condição表达式`);
			}
			break;
		}
		case STEP_TYPES.SET_ATTRIBUTE:
			var _c$target3;
			if (!!!(c === null || c === void 0 || (_c$target3 = c.target) === null || _c$target3 === void 0 || (_c$target3 = _c$target3.candidates) === null || _c$target3 === void 0 ? void 0 : _c$target3.length)) errs.push("Seletor alvo candidato ausente");
			if (!String((c === null || c === void 0 ? void 0 : c.name) || "").trim()) errs.push("需提供属性名");
			break;
		case STEP_TYPES.LOOP_ELEMENTS:
			if (!String((c === null || c === void 0 ? void 0 : c.selector) || "").trim()) errs.push("需提供Seletor de elemento");
			if (!String((c === null || c === void 0 ? void 0 : c.subflowId) || "").trim()) errs.push("需提供ID do subfluxo");
			break;
		case STEP_TYPES.SWITCH_FRAME: break;
		case STEP_TYPES.EXECUTE_FLOW:
			if (!String((c === null || c === void 0 ? void 0 : c.flowId) || "").trim()) errs.push("需选择要执行的Fluxo de trabalho");
			break;
		...
		case STEP_TYPES.SCRIPT: {
			...
			if (((c === null || c === void 0 ? void 0 : c.saveAs) || hasAssign) && !String((c === null || c === void 0 ? void 0 : c.code) || "").trim()) errs.push("Script: Configuração了Salvar/映射但缺少代码");
			if (hasAssign) {
				const pathRe = /^[A-Za-z0-9_]+(?:\.[A-Za-z0-9_]+|\[\d+\])*$/;
				for (const v of Object.values(c.assign || {})) {
					const s = String(v);
...
//#endregion
//#region ../../node_modules/.pnpm/@vue-flow+core@1.48.2_vue@3.5.33_typescript@5.9.3_/node_modules/@vue-flow/core/dist/vue-flow-core.mjs
var _excluded = ["eventFilter"], _excluded2 = ["eventFilter"], _excluded3 = ["id"], _excluded4 = [
	"computedPosition",
	"handleBounds",
	"selected",
	"dimensions",
...
function updateEdgeAction(edge, newConnection, prevEdge, shouldReplaceId, triggerError) {
	...
	const { id: id2 } = edge;
	return _objectSpread2(_objectSpread2({}, _objectWithoutProperties(edge, _excluded3)), {}, {
			...
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", _hoisted_7$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(branches.value, (b, idx) => {
					return openBlock(), createElementBlock("div", {
						key: b.id,
						class: "case-row"
					}, [createBaseVNode("div", _hoisted_8$5, toDisplayString(b.name || `Condição${idx + 1}`), 1), createVNode(unref(_sfc_main$f), {
						type: "source",
						position: unref(Position).Right,
						id: `case:${b.id}`,
	...
	setup(__props, { emit: __emit }) {
			...
			_onPick = _asyncToGenerator(function* () {
				try {
					...
					if (!res || !res.success) {
						...
						throw new Error((res === null || res === void 0 ? void 0 : res.error) || "拾取Falhou");
					}
					...
					} else err.value = "未生成有效Seletor，请手动输入";
				} catch (e) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$14, [
				...
				_cache[0] || (_cache[0] = createBaseVNode("div", { class: "help" }, "可输入 Seletor CSS，或点击“拾取”在页面中选择元素", -1)),
				err.value ? (openBlock(), createElementBlock("div", _hoisted_4$9, toDisplayString(err.value), 1)) : createCommentVNode("", true)
			]);
		};
	}
}), [["__scopeId", "data-v-a9be7aef"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$8, [
				_cache[1] || (_cache[1] = createBaseVNode("div", { class: "section-title" }, "Configuração", -1)),
				...
				errors.value.length ? (openBlock(), createElementBlock("div", _hoisted_5$5, [_cache[0] || (_cache[0] = createBaseVNode("div", { class: "error-title" }, "⚠️ ConfiguraçãoErro", -1)), (openBlock(true), createElementBlock(Fragment, null, renderList(errors.value, (e) => {
					return openBlock(), createElementBlock("div", {
						key: e,
						class: "error-item"
					}, toDisplayString(e), 1);
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return __props.node && hasSpec.value ? (openBlock(), createBlock(PropertyFormRenderer_default, {
				...
				node: __props.node,
				variables: __props.variables
			}, null, 8, ["node", "variables"])) : (openBlock(), createElementBlock("div", _hoisted_1$7, [..._cache[0] || (_cache[0] = [createBaseVNode("div", { class: "section-title" }, "未找到Nó规范", -1), createBaseVNode("div", { class: "help" }, "该Nó尚未提供 NodeSpec，已回退到默认属性面板。", -1)])]));
		};
	}
}), [["__scopeId", "data-v-ad52cb77"]]);
//#endregion
	...
	*/
	...
	function _layoutAuto() {
		_layoutAuto = _asyncToGenerator(function* () {
			try {
				const mod = yield __vitePreload(() => import("./elk.bundled-Csj217si.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), __vite__mapDeps([0,1]));
				...
				try {
					layoutFallback();
					toast("ELK Automático布局不可用，已使用备用布局", "warn");
				} catch (_unused3) {}
			}
		});
		return _layoutAuto.apply(this, arguments);
...
//#endregion
//#region ../../node_modules/.pnpm/@vue-flow+background@1.3.2__e53d8a81b6e7af576634567c5b401850/node_modules/@vue-flow/background/dist/vue-flow-background.mjs
...
var Canvas_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent(_objectSpread2(_objectSpread2({}, { name: "BuilderCanvas" }), {}, {
	__name: "Canvas",
	props: {
		nodes: {},
		edges: {},
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const nodeTypes = (() => {
			...
			for (const n of NODE_UI_LIST) {
				...
				base[key] = markRaw(n.canvas || (n.type === "if" ? NodeIf_default : NodeCard_default));
			}
			return base;
		})();
		watchEffect(() => {
...
var Sidebar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent(_objectSpread2(_objectSpread2({}, { name: "BuilderSidebar" }), {}, {
	__name: "Sidebar",
	props: {
		flow: {},
		paletteTypes: {},
...
var PropertyPanel_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		computed(() => {
			...
			const errs = [];
			if (!((_n$config6 = n.config) === null || _n$config6 === void 0 ? void 0 : _n$config6.saveAs)) errs.push("需填写SalvarNome da variável");
		...
		function _pickFromPage() {
			_pickFromPage = _asyncToGenerator(function* () {
				try {
					var _tabs$;
					if (!props.node) return;
					...
					yield ensurePickerInjected(tabId);
					const resp = yield chrome.tabs.sendMessage(tabId, { action: "rr_picker_start" });
			...
			return _pickFromPage.apply(this, arguments);
		}
		computed({
			get() {
				const n = props.node;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("aside", _hoisted_1$3, [__props.node ? (openBlock(), createElementBlock("div", _hoisted_2$3, [
				createBaseVNode("div", _hoisted_3$3, [createBaseVNode("div", null, [_cache[3] || (_cache[3] = createBaseVNode("div", { class: "header-title" }, "Nó属性", -1)), createBaseVNode("div", _hoisted_4$3, toDisplayString(__props.node.id), 1)]), createBaseVNode("button", {
					class: "btn-delete",
					type: "button",
					title: "ExcluirNó",
				...
				createBaseVNode("div", _hoisted_5$3, [createBaseVNode("div", _hoisted_6$3, [_cache[5] || (_cache[5] = createBaseVNode("label", { class: "form-label" }, "NóNome", -1)), withDirectives(createBaseVNode("input", {
					class: "form-input",
					"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => __props.node.name = $event),
					placeholder: "输入NóNome"
				...
				createBaseVNode("div", _hoisted_7$3, [
					_cache[8] || (_cache[8] = createBaseVNode("div", { class: "section-title" }, "GeralConfigurações", -1)),
					...
					}, null, 512), [[vModelCheckbox, __props.node.config.screenshotOnFail]]), _cache[7] || (_cache[7] = createBaseVNode("span", null, "Falhou时截图", -1))])])
				]),
				nodeErrors.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_11$3, [_cache[9] || (_cache[9] = createBaseVNode("div", { class: "error-title" }, "⚠️ ConfiguraçãoErro", -1)), (openBlock(true), createElementBlock(Fragment, null, renderList(nodeErrors.value, (e) => {
					return openBlock(), createElementBlock("div", {
						key: e,
						class: "error-item"
					}, toDisplayString(e), 1);
				...
				createTextVNode("选择一个Nó"),
				createBaseVNode("br"),
				createTextVNode("查看eEditar属性")
			], -1)])]))]);
		};
	}
}), [["__scopeId", "data-v-db72e2d0"]]);
//#endregion
...
var TriggerPanel_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent(_objectSpread2(_objectSpread2({}, { name: "TriggerPanel" }), {}, {
	__name: "TriggerPanel",
	props: { flowId: {} },
	emits: ["close"],
	setup(__props, { emit: __emit }) {
		...
		function openCreate(kind) {
			...
			editorWhenLocal.value = unixMsToDatetimeLocal(Date.now() + 300 * 1e3);
...
createApp(/* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "App",
	setup(__props) {
		const title = ref("Editor de fluxos");
			...
			_bootstrap = _asyncToGenerator(function* () {
				...
				if (q.flowId) try {
					...
					if (flowV3) {
						...
						title.value = `Editando: ${flowV2.name || flowV2.id}`;
						...
						pushToast(`Fluxo "${q.flowId}" não encontrado, novo fluxo criado`, "warn");
						initEmptyFlow();
					}
				} catch (e) {
					pushToast(`Falha ao carregar fluxo: ${e instanceof Error ? e.message : String(e)}`, "error");
					initEmptyFlow();
				}
		...
		*/
		...
		/**
		* Salvar Flow 到 V3 RPC
		* @returns SalvarSucessoVoltar FlowV3，FalhouVoltar null
		*/
		function save() {
		...
		function _save() {
			_save = _asyncToGenerator(function* () {
				try {
					...
					pushToast(`SalvarFalhou：${e instanceof Error ? e.message : String(e)}`, "error");
					return null;
				}
			});
			return _save.apply(this, arguments);
		...
		/**
		* 将 V2 schedule Configuração转换为 cron 表达式
		* @returns cron 表达式或 null（如果Nenhum法转换）
		*/
		...
		/**
		* 从 trigger NóConfiguração同步触发器到 V3 存储
		...
		*/
				...
				for (const n of tnodes) {
					...
					if (((_cfg$modes5 = cfg.modes) === null || _cfg$modes5 === void 0 ? void 0 : _cfg$modes5.schedule) && Array.isArray(cfg.schedules)) cfg.schedules.forEach((s, i) => {
						...
						if (!cron) {
							...
							if (scheduleType === "once") pushToast(`Nó ${n.id} 的Temporizado #${i + 1}: V3 暂不支持一次性Temporizado（once），已跳过`, "warn");
							else pushToast(`Nó ${n.id} 的Temporizado #${i + 1}: Nenhum法转换为 cron（type=${scheduleType}），已跳过`, "warn");
							return;
						}
						triggersNeeded.push({
		...
		function _exportFlow() {
			_exportFlow = _asyncToGenerator(function* () {
				try {
					...
					pushToast(`ExportarFalhou：${e instanceof Error ? e.message : String(e)}`, "error");
				}
			});
			return _exportFlow.apply(this, arguments);
		}
			...
			_onImport = _asyncToGenerator(function* (e) {
				...
				try {
					...
					if (!candidates.length) {
						pushToast("ImportarFalhou：未找到Fluxo de trabalho数据", "error");
						return;
					}
					...
					if (isFlowV3(first)) {
						...
						title.value = `Editar：${store.flowLocal.name || store.flowLocal.id}`;
						yield save();
					}
				} catch (e) {
					pushToast(`ImportarFalhou：${e instanceof Error ? e.message : String(e)}`, "error");
				} finally {
					input.value = "";
				}
			});
		...
		function _runFromSelected() {
			_runFromSelected = _asyncToGenerator(function* () {
				...
				try {
					...
					pushToast(`Falha ao executar: ${e instanceof Error ? e.message : String(e)}`, "error");
				}
			});
			return _runFromSelected.apply(this, arguments);
		}
		...
		const saveLabel = computed(() => saveState.value === "saving" ? "Salvar中…" : saveState.value === "saved" ? "已Salvar" : "");
		let saveTimer = null;
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", {
				...
				fallbackNotice.value ? (openBlock(), createElementBlock("div", _hoisted_2, [createBaseVNode("span", null, "已Aplicar回退建议：提升 " + toDisplayString(fallbackNotice.value.type) + " 优先级", 1), createBaseVNode("button", {
					class: "mini",
					onClick: undoFallbackPromotion
				}, "Desfazer")])) : createCommentVNode("", true),
				createBaseVNode("div", _hoisted_3, [
					...
					createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [createBaseVNode("strong", _hoisted_6, toDisplayString(title.value), 1), _cache[8] || (_cache[8] = createBaseVNode("span", { class: "tip" }, "Fluxo de trabalho可视化编排", -1))]), createBaseVNode("div", _hoisted_7, [
						createBaseVNode("button", {
							...
							stroke: "currentColor",
							"stroke-width": "2"
						}, [createBaseVNode("path", { d: "M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3" })], -1), createTextVNode(" Exportar ", -1)])]),
						createBaseVNode("label", _hoisted_8, [
							...
							_cache[11] || (_cache[11] = createTextVNode(" Importar ", -1)),
							createBaseVNode("input", {
								type: "file",
						...
						createBaseVNode("button", {
							...
							title: "Reproduzir a partir do nó selecionado"
							...
							stroke: "currentColor",
							"stroke-width": "2"
						}, [createBaseVNode("polygon", { points: "5 3 19 12 5 21 5 3" })], -1), createTextVNode(" 从选中Executar ", -1)])], 8, _hoisted_9),
						createBaseVNode("button", {
							class: "top-btn primary",
							onClick: runAll,
							title: "Reproduzir do início"
						}, [..._cache[15] || (_cache[15] = [createBaseVNode("svg", {
							width: "14",
							height: "14",
							viewBox: "0 0 24 24",
							...
							stroke: "currentColor",
							"stroke-width": "2"
						}, [createBaseVNode("polygon", { points: "5 3 19 12 5 21 5 3" })], -1), createTextVNode(" Executar ", -1)])]),
					...
					createBaseVNode("div", _hoisted_11, [
						...
						}, [..._cache[21] || (_cache[21] = [createStaticVNode("<svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" data-v-936ca250><rect x=\"3\" y=\"3\" width=\"7\" height=\"7\" rx=\"1\" data-v-936ca250></rect><rect x=\"14\" y=\"3\" width=\"7\" height=\"7\" rx=\"1\" data-v-936ca250></rect><rect x=\"14\" y=\"14\" width=\"7\" height=\"7\" rx=\"1\" data-v-936ca250></rect><rect x=\"3\" y=\"14\" width=\"7\" height=\"7\" rx=\"1\" data-v-936ca250></rect></svg>", 1)])]),
						createBaseVNode("button", {
							class: "toolbar-btn",
							onClick: fitAll,
							title: "Visão adaptativa"
				...
				createBaseVNode("div", _hoisted_16, [_cache[24] || (_cache[24] = createBaseVNode("div", { class: "title" }, "Renomear fluxo", -1)), createBaseVNode("button", {
					class: "close",
					onClick: _cache[5] || (_cache[5] = ($event) => renameVisible.value = false)
				}, "✕")]),
				createBaseVNode("div", _hoisted_17, [createBaseVNode("div", _hoisted_18, [_cache[25] || (_cache[25] = createBaseVNode("label", null, "Nome", -1)), withDirectives(createBaseVNode("input", {
					"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => renameName.value = $event),
					placeholder: "Nome do fluxo"
				}, null, 512), [[vModelText, renameName.value]])]), createBaseVNode("div", _hoisted_19, [_cache[26] || (_cache[26] = createBaseVNode("label", null, "Descrição", -1)), withDirectives(createBaseVNode("textarea", {
...
}), [["__scopeId", "data-v-936ca250"]])).mount("#app");
//#endregion
