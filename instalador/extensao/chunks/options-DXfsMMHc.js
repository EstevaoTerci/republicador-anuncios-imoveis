...
import { A as onMounted, M as openBlock, P as renderList, W as withDirectives, a as vModelText, ct as toDisplayString, et as ref, f as createBaseVNode, h as createElementBlock, i as vModelSelect, l as Fragment, m as createCommentVNode, n as createApp, r as vModelCheckbox, v as createTextVNode, x as defineComponent } from "./runtime-dom.esm-bundler-D0J2iYbf.js";
...
import { i as TOOL_NAMES } from "./dist-DwEL_LJB.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Bzyu2s-i.js";
import { r as STORAGE_KEYS } from "./constants-BrHJ3XIU.js";
	...
	setup(__props) {
		...
		function _loadEmergency() {
			_loadEmergency = _asyncToGenerator(function* () {
				...
				emergencyDisabled.value = !!(yield (_globalThis$chrome2 = globalThis.chrome) === null || _globalThis$chrome2 === void 0 || (_globalThis$chrome2 = _globalThis$chrome2.storage) === null || _globalThis$chrome2 === void 0 ? void 0 : _globalThis$chrome2.local.get([STORAGE_KEYS.USERSCRIPTS_DISABLED]))[STORAGE_KEYS.USERSCRIPTS_DISABLED];
			});
			return _loadEmergency.apply(this, arguments);
		}
		...
		function _reload() {
			_reload = _asyncToGenerator(function* () {
				...
				try {
					...
					items.value = JSON.parse(txt).items || [];
				} catch (e) {
