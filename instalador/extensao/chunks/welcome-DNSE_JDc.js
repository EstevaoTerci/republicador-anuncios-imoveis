...
import { M as openBlock, P as renderList, _ as createStaticVNode, ct as toDisplayString, et as ref, f as createBaseVNode, h as createElementBlock, l as Fragment, n as createApp, st as normalizeStyle, v as createTextVNode, x as defineComponent } from "./runtime-dom.esm-bundler-D0J2iYbf.js";
...
/* empty css                  */
import { n as NATIVE_HOST, t as LINKS } from "./constants-BrHJ3XIU.js";
/* empty css                    */
...
var _hoisted_10 = { class: "welcome-card welcome-card--primary p-6" };
var _hoisted_11 = { class: "mt-4 space-y-3" };
var _hoisted_12 = { class: "welcome-command-row flex items-center justify-between gap-3 px-4 py-3" };
var _hoisted_13 = { class: "welcome-code text-sm break-all" };
var _hoisted_14 = { class: "grid sm:grid-cols-2 gap-3" };
var _hoisted_15 = { class: "min-w-0" };
var _hoisted_16 = { class: "welcome-mono welcome-subtle text-[10px] uppercase tracking-widest font-medium" };
var _hoisted_17 = { class: "welcome-code text-xs break-all" };
var _hoisted_18 = ["onClick"];
var _hoisted_19 = {
	class: "mt-6 pt-5",
	style: { borderTop: "var(--ac-border-width) solid var(--ac-border)" }
};
var _hoisted_20 = { class: "welcome-command-row mt-3 flex items-center justify-between gap-3 px-4 py-3" };
var _hoisted_21 = { class: "welcome-code text-sm break-all" };
var _hoisted_22 = { class: "welcome-card overflow-hidden" };
var _hoisted_23 = { class: "px-6 pb-6 space-y-4" };
var _hoisted_24 = { class: "welcome-alt-row p-4" };
var _hoisted_25 = { class: "mt-3 space-y-2" };
var _hoisted_26 = { class: "min-w-0" };
var _hoisted_27 = { class: "welcome-mono welcome-subtle text-[10px] uppercase tracking-widest font-medium" };
var _hoisted_28 = { class: "welcome-code text-xs break-all" };
var _hoisted_29 = ["onClick"];
var _hoisted_30 = { class: "welcome-report-card p-4" };
var _hoisted_31 = { class: "welcome-command-row mt-3 flex items-center justify-between gap-3 px-3 py-2" };
...
createApp(/* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("header", _hoisted_3, [createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [createBaseVNode("div", _hoisted_6, [(openBlock(), createElementBlock("svg", _hoisted_7, [..._cache[3] || (_cache[3] = [createBaseVNode("path", {
			...
			}, null, -1)])]))]), _cache[4] || (_cache[4] = createBaseVNode("div", { class: "min-w-0" }, [createBaseVNode("h1", { class: "welcome-title text-lg font-medium tracking-tight truncate" }, " Chrome MCP Server "), createBaseVNode("p", { class: "welcome-muted text-sm truncate" }, " After the extension is installed, this is the only required step. ")], -1))]), createBaseVNode("button", {
				class: "welcome-button px-3 py-2 text-xs font-medium ac-btn flex-shrink-0",
				onClick: openDocs
			}, " Troubleshooting Docs ")])]), createBaseVNode("main", _hoisted_8, [createBaseVNode("div", _hoisted_9, [createBaseVNode("section", _hoisted_10, [
				...
				createBaseVNode("div", _hoisted_11, [
					createBaseVNode("div", _hoisted_12, [createBaseVNode("code", _hoisted_13, toDisplayString(COMMANDS.npmInstall), 1), createBaseVNode("button", {
					...
					createBaseVNode("div", _hoisted_14, [(openBlock(), createElementBlock(Fragment, null, renderList(ALT_INSTALL, (item) => {
						return createBaseVNode("div", {
							key: item.key,
							class: "welcome-alt-row flex items-center justify-between gap-3 px-4 py-3"
						}, [createBaseVNode("div", _hoisted_15, [createBaseVNode("div", _hoisted_16, toDisplayString(item.label), 1), createBaseVNode("code", _hoisted_17, toDisplayString(COMMANDS[item.key]), 1)]), createBaseVNode("button", {
							class: "welcome-mono px-2 py-1 text-xs font-medium ac-btn flex-shrink-0",
				...
				createBaseVNode("div", _hoisted_19, [
					...
					createBaseVNode("div", _hoisted_20, [createBaseVNode("code", _hoisted_21, toDisplayString(COMMANDS.mcpUrl), 1), createBaseVNode("button", {
						class: "welcome-mono px-2 py-1 text-xs font-medium ac-btn flex-shrink-0",
			...
			]), createBaseVNode("details", _hoisted_22, [_cache[16] || (_cache[16] = createStaticVNode("<summary class=\"px-6 py-4 cursor-pointer select-none flex items-center justify-between gap-4\" data-v-e65b186e><div class=\"min-w-0\" data-v-e65b186e><div class=\"welcome-title text-sm font-medium\" data-v-e65b186e>Troubleshooting</div><div class=\"welcome-muted text-xs truncate\" data-v-e65b186e> Use these only if the bridge fails to register or connect. </div></div><span class=\"welcome-mono welcome-subtle text-xs flex-shrink-0\" data-v-e65b186e>doctor · report</span></summary>", 1)), createBaseVNode("div", _hoisted_23, [
				createBaseVNode("div", _hoisted_24, [
					...
					createBaseVNode("div", _hoisted_25, [(openBlock(), createElementBlock(Fragment, null, renderList(DIAGNOSTICS, (item) => {
						return createBaseVNode("div", {
							key: item.key,
							class: "welcome-command-row flex items-center justify-between gap-3 px-3 py-2"
						}, [createBaseVNode("div", _hoisted_26, [createBaseVNode("div", _hoisted_27, toDisplayString(item.label), 1), createBaseVNode("code", _hoisted_28, toDisplayString(COMMANDS[item.key]), 1)]), createBaseVNode("button", {
							class: "welcome-mono px-2 py-1 text-xs font-medium ac-btn flex-shrink-0",
							style: normalizeStyle({ color: copyColor(item.key) }),
							onClick: ($event) => copyCommand(item.key)
				...
				createBaseVNode("div", _hoisted_30, [
					...
					createBaseVNode("div", _hoisted_31, [createBaseVNode("code", _hoisted_32, toDisplayString(COMMANDS.report), 1), createBaseVNode("button", {
						class: "welcome-mono px-2 py-1 text-xs font-medium ac-btn flex-shrink-0",
...
}), [["__scopeId", "data-v-e65b186e"]])).mount("#app");
//#endregion
