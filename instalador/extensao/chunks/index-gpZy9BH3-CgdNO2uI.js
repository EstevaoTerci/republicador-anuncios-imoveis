import { A as onMounted, D as nextTick, F as renderSlot, M as openBlock, S as getCurrentInstance, V as watch, W as withDirectives, at as unref, c as withModifiers, ct as toDisplayString, d as computed, et as ref, f as createBaseVNode, h as createElementBlock, j as onUnmounted, k as onBeforeUnmount, l as Fragment, m as createCommentVNode, o as vShow, ot as normalizeClass, p as createBlock, st as normalizeStyle, u as Teleport, x as defineComponent } from "./runtime-dom.esm-bundler-D0J2iYbf.js";
import { a as Us, d as mo$1, g as zl, i as Pl, l as fo$1, m as uo$1, n as Dn, o as Ys, p as qo, s as Z, t as Ba, u as mn } from "./sidepanel-BOvzUtQE.js";
//#region ../../node_modules/.pnpm/markstream-vue@0.0.3-beta.5_vue@3.5.33_typescript@5.9.3_/node_modules/markstream-vue/dist/index-gpZy9BH3.js
...
var Kt = { class: "html-preview-frame__header" }, Jt = { class: "html-preview-frame__title" }, Qt = { class: "html-preview-frame__label" }, Zt = ["srcdoc"], to = /* @__PURE__ */ Z(/* @__PURE__ */ defineComponent({
...
<html lang="en">
  ...
  <body>
	...
	"aria-live": "polite",
	role: "status"
}, Je = "__markstreamMonacoPassiveTouch__", Qe = 10, Ze = 36, et = 1, tt = 0, ot = 1.5, ue = 1, Se = /* @__PURE__ */ Z(/* @__PURE__ */ defineComponent({
	...
	setup(f, { emit: s }) {
		...
		function ct() {
			const t = we();
			v.value = Math.min(Ze, t + et);
		}
		function dt() {
			const t = we();
			v.value = Math.max(Qe, t - et);
		}
		function ft() {
