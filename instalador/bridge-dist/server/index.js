...
class Server {
    constructor() {
        ...
        this.agentChatService = new chat_service_1.AgentChatService({
            engines: [new codex_1.CodexEngine(), new claude_1.ClaudeEngine()],
    ...
    setupMcpRoutes() {
        ...
        this.fastify.get('/sse', async (_, reply) => {
            try {
                ...
                // Idem do /mcp: cada SSE session recebe sua propria instancia.
        ...
        this.fastify.post('/mcp', async (request, reply) => {
            ...
            if (transport) {
                ...
                // Cada sessao HTTP recebe sua propria instancia de Server (NAO
                // singleton). Sem isso, o segundo cliente que faz initialize recebe
                // "Already connected to a transport" do MCP SDK, porque
                // Server.connect() so pode ser chamado uma vez por instancia.
                await (0, mcp_server_1.createMcpServer)().connect(transport);
            }
            else {
